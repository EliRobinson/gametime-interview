  ...
  theme: {
    extend: {
      colors: {
        ...
        guarantee: colors.guarantee,
        stadium: {
          bowl: colors.stadiumBowl,
          'bowl-dark': colors.stadiumBowlDark,
          field: colors.stadiumField,
          'field-dark': colors.stadiumFieldDark,
          stage: colors.stadiumStage,
          map: colors.stadiumMapBg,
          'map-dark': colors.stadiumMapBgDark,
        },
        link: colors.link,
        ink: colors.text,
